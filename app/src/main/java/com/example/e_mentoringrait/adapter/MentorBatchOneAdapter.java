...
import com.example.e_mentoringrait.mentor.MentorMentee;
import com.example.e_mentoringrait.model.DataMentee;
import com.firebase.ui.database.FirebaseRecyclerAdapter;
import com.firebase.ui.database.FirebaseRecyclerOptions;

public class MentorBatchOneAdapter extends FirebaseRecyclerAdapter<DataMentee,MentorBatchOneAdapter.myViewHolder> {
     ...
     * @param options
     */
    public MentorBatchOneAdapter(@NonNull FirebaseRecyclerOptions<DataMentee> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull DataMentee model) {
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, MentorMentee.class);
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MentorBatchOneAdapter.myViewHolder(view);
    }
